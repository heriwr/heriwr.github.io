...
A Save is a roll to avoid a bad outcome from risky choices and circumstances, generally whenever something bad happens to the you or you want to do something. To save, ■■ and compare the result to their Life or Guard, whichever the Cyfarwydd determines. 

When considering whether to roll a Save, note whether the PC has the Time or Gear to complete the task.
...
The result must be under the PC's Life or Guard to succeed. A result equal to the PC's Life or Guard is a partial success with a **consequence**. 

On a failure, PCs face a consequence. 
...
Life represents a PCs ability to cope well under external (physical, mental, spiritual etc.) pressure.

PCs must also save whenever they attempt **direct** actions like fleeing, bending things, smashing doors down, swinging on a rope, scaling walls or falling from a great height.
...
Life is regained at night when the TP's rest.
