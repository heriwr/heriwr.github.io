...
Actions may approached in three ways: **Direct**, **Discrete** and **Resourceful**. A Direct action requires a Life save, while Discrete or Resourceful actions require a Guard Save (⛨).
...
Life represents a PCs ability to cope well under external (physical, mental, spiritual etc.) pressure. PCs make a Life Save whenenever they must resist Fear, Panic, Poison, Wands, Paralysis, Grappling, Breath Weapons or Charm.

PCs must also roll against their Life whenever they attempt **direct** actions like fleeing, bending things, smashing doors down, swinging on a rope, scaling walls or falling from a great height.
