...
A Save is a roll to avoid a bad outcome from risky choices and circumstances, generally whenever something happens to the PC. To save, PCs roll 2d6 and compare the result to their **Life** or **Guard**, whichever the Bard determines. The result must be under the PC's Life or Guard to succeed. A result equal to the PC's Life or Guard is "not quite" or a partial success with some kind of complication.

A Skill Test is made whenever the PC wishes to do something and failure would produce an interesting outcome. PCs may approach tasks in three ways: **Direct**, **Discrete** and **Resourceful**. A skill test is a 1d6 roll and the result must be equal or under the PC's approach level (i.e. the character's Direct approach is 4 and they roll 2, meaning they succeed).

## Life

A character may not have more than 11 Life. // Consider whether this is necessary if a roll of 12 could just be a partial success.

Life represents their ability to cope well under external (physical, mental, spiritual etc.) pressure. PCs make a Life Save whenenever they must resist poison, break free from being grappled, flee or anything else that puts the PC in mortal danger.
