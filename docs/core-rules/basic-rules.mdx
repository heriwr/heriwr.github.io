...
A Save is a roll to avoid a bad outcome from risky choices and circumstances, generally whenever something happens to the PC. To save, PCs roll 2d6 and compare the result to their ♥ or ⛨, whichever the Cyfarwydd determines. 
...
The result must be under the PC's ♥ or ⛨ to succeed. A result equal to the PC's Life ♥ or ⛨ is a partial success with a consequence. 
