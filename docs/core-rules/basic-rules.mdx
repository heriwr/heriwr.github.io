...
A Save is a roll to avoid a bad outcome from risky choices and circumstances, generally whenever something happens to the PC. To save, PCs roll 2d6 and compare the result to their **Life** or **Guard**, whichever the Bard determines. The result must be equal or under the PC's Life or Guard to succeed.
