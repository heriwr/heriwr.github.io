...
The attacker rolls damage and subtracts the target’s Armour, then deals the remaining total to their opponent’s ⛨. If ⛨ is reduced to 0, the remaining damage is dealth directly to the target's Life.
